...
if fair_value >= (price):
  print ("Loan is worth the cost to buy it")
    ...
    print ("loan is expensive and not worth the price")
...
#     statement1
#     variable_to_return = 123456
#     return variable_to_return

# to actually use your function
# name_of_function(1,2)
# future value, months, discount 

def present_value(future_value, remaining_months, discount_rate):
    pv = future_value / (1 + discount_rate/12) ** remaining_months
    return pv


var1 = present_value(1000,12,0.2)
...
print (f"The present value of the loan is: {var1}")
